...
DROP DATABASE IF EXISTS `dev-demo`; 
SET default_storage_engine=InnoDB;
SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE DATABASE IF NOT EXISTS `dev-demo`
...
CREATE TABLE RegularUser (
    ...
    postal_code VARCHAR(5) NOT NULL,
    PRIMARY KEY (email),
    FOREIGN KEY `fk_PostalCode` (postal_code)
...
CREATE TABLE VideoGameItem (
    ...
    FOREIGN KEY `fk_video_platform` (video_game_platform)
...
;
INSERT INTO VideoGamePlatform VALUES ('Nintendo'), 
('PlayStation'), ('Xbox')
